...
def build_postfix_text_block() -> Image.Image:
    ...
    text = [
        ("GO GREEN PACKAGE", [
            ...
            "함께 보내드리는 면 파우치는 주얼리 보관 외에도 일상의 작은 소품들을 담는 용도로 자유롭게 재사용해 보세요. 제품의 안전한 보관을 위한 폴리백과 더파트오브 정품 보증서를 함께 보내드립니다. 배송 건당 한 개의 패키지로 구성되나, 상품별로 개별 포장이 필요하신 경우 요청해 주시면 준비해 드리겠습니다.",
        ]),
        ("ORDER", [
        ...
        ("EXCHANGE / RETURN", [
            "모든 교환 및 환불 문의는 카카오톡 채널 @thepartof 또는 홈페이지 Q&A게시판을 통해 접수해 주시기 바랍니다.",
        ...
        ("AFTER SERVICE", [
            "품질 보증 기간은 보증서 기준이며, 제품별로 수리 가능 여부가 다를 수  있습니다. 제품을 보내시기 전에 A/S 가능 여부를 카카오톡 채널을 통해 확인바랍니다.",
