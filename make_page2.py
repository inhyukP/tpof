...
def build_postfix_text_block() -> Image.Image:
    ...
    text = [
        ("GO GREEN PACKAGE", [
            ...
            "면 파우치는 주얼리 외에도 작은 물건을 담아 보관하는 용도로 재사용하실 수 있습니다.",
            "제품의 보관을 위한 폴리백과 더파트오브 정품 보증서를 함께 보내드립니다. 배송 1건당 한 개의 패키지가 제공되나 상품별 별도 포장이 필요하실 경우 추가 개별 포장을 요청 바랍니다.",
        ]),
        ("ORDER", [
            " ",
            "[일반 상품] 주문 확인 후 1~3일 내로 배송됩니다.",
            "[주문 제작 상품] 사이즈/이니셜 선택이 필요한 제품은 핸드메이드 주문 제작으로 영업일 기준 7일-14일 제작 기간이 소요될 수 있습니다.",
            "급한 주문건은 카카오턱 채널 @thepartof로 문의 바랍니다.",
            "상품 제작은 주문 확인 후 시작되며 검수 후 출고됩니다.",
        ]),
        ("EXCHANGE / RETURN", [
            " ",
            "교환/환불 접수: 모든 문의는 카카오톡 채널 @thepartof 또는 홈페이지 Q&A 게시판을 통해 이용해 주세요.",
            "검수 및 출고: 더파트오브는 엄격한 검수 과정을 거쳐 최상의 상태로 제품을 발송합니다.",
            "불량 접수 안내: 만약 제품에 결함이 있는 경우, 수령 후 24시간 이내에 카카오톡이나 게시판으로 사진과 함께 접수 부탁드립니다.",
            "회수 절차: 원활한 처리를 위해 접수 후 7일 이내에 해당 택배사를 통한 제품 회수가 완료되어야 합니다.",
            "불량 상품 처리: 초기 상품 불량은 동일한 새 제품으로 교환해 드립니다.",
            "A/S 안내: 착용 후 발생한 문제는 A/S 상담을 통해 도와드리며, 수리 내용에 따라 비용이 발생할 수 있습니다."
        ]),
        ("AFTER SERVICE", [
            " ",
            "품질 보증 기간은 보증서 기준이며, 제품별로 수리 가능 여부가 다를 수 있습니다.",
            "제품을 보내시기 전에 A/S 가능 여부를 카카오톡 채널을 통해 확인 바랍니다.",
